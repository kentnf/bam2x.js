...
var bam2x=bam2x || {};
 ...
 C.plot_json = function(data,el_id) {
    ...
    legend.selectAll("circle").data(trackNames).enter().append("circle").attr("cy",function(d,i) {return cy/3 + i*15 -5}).attr("cx",cx+outerRadius+10).attr("fill",function(d,i) {return data.tracks[i].color || "black"}).attr("r",2);
